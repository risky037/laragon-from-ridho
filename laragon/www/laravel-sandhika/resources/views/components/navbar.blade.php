<nav class="bg-gray-800" x-data="{ isOpen: false }">
    ...
    <div x-show='isOpen' class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <a href="posts" class="{{request() -> is('posts') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}} block rounded-md px-3 py-2 text-base font-medium">Blog</a>
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">Basuki Ridho</div>
            <div class="text-sm font-medium leading-none text-gray-400">Sukisuki@example.com</div>
          </div>
        </div>
